...
class ResumenVentasTest extends TestCase
{
    ...
    public function test_resumen_con_filtros()
    {
        ...
        Venta::create(['id_venta' => 'V1', 'fecha' => '2026-01-01', 'vendedor' => 'V', 'region' => 'Norte', 'producto' => 'P', 'monto' => 100, 'estatus' => 'cerrada']);
        Venta::create(['id_venta' => 'V2', 'fecha' => '2026-02-01', 'vendedor' => 'V', 'region' => 'Norte', 'producto' => 'P', 'monto' => 200, 'estatus' => 'cerrada']);
        Venta::create(['id_venta' => 'V3', 'fecha' => '2026-03-01', 'vendedor' => 'V', 'region' => 'Norte', 'producto' => 'P', 'monto' => 300, 'estatus' => 'cerrada']);
